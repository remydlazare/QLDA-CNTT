      ...
      <div class="row">
       <!-- Left Image-->
        <div class="col-lg-5">
          ...
          <span>Di chuyển chuột trên Hình ảnh để thu phóng</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="productprice">
                ...
                <div class="productpageoldprice">Old price : {!! $product_detail->price !!}đ</div>
                @endif
                <ul class="rate">
                  <li class="on"></li>
                  <li class="on"></li>
...
<!--                 <div class="control-group">
              ...
              @if($product_detail->status == 0)
                <button disabled type="submit" class="btn btn-orange" style="font-size: 20px"><span class="glyphicon glyphicon-shopping-cart"></span> Mua Ngay</button>
              @else
              <button type="submit" class="btn btn-orange" style="font-size: 20px"><span class="glyphicon glyphicon-shopping-cart"></span> Mua Ngay</button>
              @endif
...
<!--             <div class="shortlinks">
  ...
  <section id="popularbrands" class="container">
    <h1 class="heading1"><span class="maintext">CÁC THƯƠNG HIỆU PHỔ BIẾN</span></h1>
