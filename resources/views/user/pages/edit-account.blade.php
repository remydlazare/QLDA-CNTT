    ...
    <div class="container">
     <!--  breadcrumb --> 
      ...
      <div class="row">
        ...
        <!-- My Account-->
      <div class="col-lg-9">
        <h1 class="heading1"><span class="maintext"> SỬA TÀI KHOẢN</span><span class="subtext">Chỉnh sửa thông tin tài khoản của bạn</span></h1>
      <form action="" method="POST">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            <div class="form-group">
                <label>Tài khoản</label>
                <input type="text" class="form-control" name="txtUser" placeholder="Please Enter Username" value="{!! old('txtUser',isset($user_edit) ? $user_edit['username'] : null) !!}" disabled />
            </div>
            <div class="form-group">
          ...
          <aside class="col-lg-3">
            <div class="sidewidt">
              ...
              <ul class="nav nav-list categories">
                ...
                <li><a href="{!! url('order-history') !!}">Lịch sử đặt hàng</a>
                </li>
                <li>
                  <a href=" {!! url('logout') !!}">Dăng xuất</a>
                </li>
              </ul>
            </div>
          </aside>
