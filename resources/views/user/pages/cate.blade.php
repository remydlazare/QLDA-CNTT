...
<!--                       <div class="shortlinks">
                      ...
                      <div class="pricetag">
                        @if($item_product_cate->status == 0)
                          <span class="spiral"></span><a href="{!! url('product-detail',[$item_product_cate->id,$item_product_cate->alias]) !!}" class="productcart">Mua ngay</a>
                        @else
                          <span class="spiral"></span><a href="{!! url('add-to-cart',[$item_product_cate->id,$item_product_cate->alias]) !!}" class="productcart">Mua ngay</a>
                        @endif
                        <div class="price">
                          @if($item_product_cate->price_new == 0)
