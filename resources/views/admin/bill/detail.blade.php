...
<table class="table table-bordered table-hover" role="grid" aria-describedby="example2_info">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{!! $bill->size !!}</td>
            <td>{!! $bill->quantity !!}</td>
            <td>{!! $bill->unit_price*$bill->quantity !!}đ</td>
        </tr>
        @endforeach
        <tr>
            <td colspan="4"><b>VAT (5%)</b></td>
            <td colspan="1"><b class="text-red">{!! number_format($customerInfo->total/1.05*0.05,1) !!}đ</b></td>
        </tr>
        <tr>
            <td colspan="4"><b>Total Pay</b></td>
            <td colspan="1"><b style="color: red;">{!! $customerInfo->total !!}đ</b></td>
        </tr>
    </tbody>
</table>
<div class="col-lg-12">
